...
if __name__=='__main__':
    ...
    # make a new meal
    meal_one                        = Opti_Meal (
                                                    meal_name                   = "Bacon & Fruit"
                                                    #food_type_filename          = ""                ,
                                                    #starting_opti_ingredients   = None              
                                                )
    
    # add the food, locked for changes (NB: actual values, do not change) 
    meal_one.add_food_type( Food_Type("Cream"  ,   0.360, 0.020, 0.030, 3.440, 1.000) )
    meal_one.add_food_type( Food_Type("Fruit",     0.000, 0.010, 0.100, 0.440, 1.000) )
    meal_one.add_food_type( Food_Type("Bacon",     0.389, 0.389, 0.028, 5.170, 1.000) )
    meal_one.add_food_type( Food_Type("Olive Oil", 1.000, 0.000, 0.000, 9.000, 1.000) )


    # add the ingredients, with their per-ingredient options 
    meal_one.add_opti_ingredient(
                                    new_opti_ingredient = "Cream",
                                    #grams_minimum                     = None,   
                                    #grams_maximum                     = None,   
                                    use_in_objective_function         = False   
                                    #points_per_gram                   = None,   
                                    #target_grams                      = None
                                )

    meal_one.add_opti_ingredient(
                                    new_opti_ingredient = "Fruit",
                                    grams_minimum                     = 10.0,   
                                    #grams_maximum                     = None,   
                                    use_in_objective_function         = False  
                                    #points_per_gram                   = None,   
    ...
    # choose the optimization constraints and options

    meal_one.set_debug(debug_mode)
    
    meal_one.set_objective_function_type(0)     # 0 == nothing (feasibility), 
                                                # 1 == minimize,
                                                # 2 == maximize,
                                                # 3 == minimize the maximum (min-max),
                                                # 4 == maximize the minimum (max-min)
                                                
    #meal_one.set_fat_grams_minimum()                                          
    #meal_one.set_fat_grams_maximum()  
    meal_one.set_protein_grams_minimum(7.36)                                          
    #meal_one.set_protein_grams_maximum()  
    #meal_one.set_carbs_grams_minimum()                                          
    #meal_one.set_carbs_grams_maximum()
    meal_one.set_calories_minimum(221)
    meal_one.set_calories_maximum(229) 
    #meal_one.set_milliliters_minimum()  
    #meal_one.set_milliliters_maximum()                                           
    #meal_one.set_ratio_minimum(1.5.1)
    #meal_one.set_ratio_maximum()
    meal_one.set_rounding_digits(4)
    #meal_one.set_use_points_in_objective_function(True)           
    #meal_one.set_use_total_fat_in_objective_function(True) 
    #meal_one.set_use_total_protein_in_objective_function(True) 
    #meal_one.set_use_total_carbs_in_objective_function(True) 
    #meal_one.set_use_total_calories_in_objective_function(True) 
    #meal_one.set_use_total_volume_in_objective_function(True) 
    #meal_one.set_use_ratio_in_objective_function(True)      
